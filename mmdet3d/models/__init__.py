...
from .builder import (BACKBONES, DETECTORS, FUSION_LAYERS, HEADS, LOSSES,
                      ...
                      SHARED_HEADS, VOXEL_ENCODERS, RENDERERS,
                      ...
                      build_shared_head, build_voxel_encoder, build_renderer)
...
from .renderers import * # This now correctly imports PulsarRenderer
